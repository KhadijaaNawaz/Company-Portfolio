...
const IoTSolutions = () => {
  const breadcrumbs = [
    ...
    { text: "IoTSolutions", isActive: true },
  ];

  const services = [
    "Smart device setup and integration",
    "IoT security services",
    "Monitoring and maintenance of IoT networks",   
  ];
      ...
      <div >
        ...
        <Structure 
          ...
          WhatWeDoComponent={
            <WhatWeDo
              title="What We Do"
              description="We turn businesses into smart enterprises with our IoT Solutions. Whether it’s smart automation, remote monitoring, or industrial IoT, we integrate intelligent technologies to improve efficiency, security, and operational control. "
              services={services}
