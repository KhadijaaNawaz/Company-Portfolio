  ...
  return (
    <div className={styles.imageWithBackground} style={style}>
      <div className={styles.backgroundSvg}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className={styles.svg}>
          {backgroundSvg}
        </svg>
      </div>
